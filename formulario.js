window.onload = function () {
    var formInputs = { 'Id': 'number', 'Nombre': 'text', 'Apellido': 'text', 'Fecha de Nacimiento': 'date', 'Masculino': 'radio', 'Femenino': 'radio', 'No definido': 'radio' };
    var formButtons = { 'Enviar': 'btnSend', 'X': 'closeForm' };
    var formulario = new Formulario('mainForm');
    formulario.createForm(formInputs, formButtons, 'centro formulario');
    //Estilos
    formulario.setDivButtonsClass('botonesGroup');
    formulario.setFormButtonsClass('blueButton');
    formulario.setDivInputsClass('inputsGroup');
    formulario.setDivRadiosClass('radioGroup');
    formulario.setFormCloseButton('closeButton');
    formulario.setFormLabelsClass('formLabel');
};
var Formulario = /** @class */ (function () {
    ...
    Formulario.prototype.hideForm = function () {
        this.closeForm();
    };
    ...
    //Si es un boton de cierre lo setea.
    Formulario.prototype.setCloseButton = function (button) {
        if (button['name'].toLowerCase() === 'x' || button['name'].toLowerCase() === 'close' || button['name'].toLowerCase() === 'cerrar') {
            button.onclick = function () { this.closeForm(); };
    ...
    Formulario.prototype.createInput = function (label, type) {
        ...
        input.hidden = this.isIdField(label);
        ...
        input.setAttribute('id', label.toLowerCase());
