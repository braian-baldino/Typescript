window.onload = function(){
    const formInputs = {'Id':'number','Nombre':'text','Apellido':'text','Fecha de Nacimiento':'date','Masculino':'radio','Femenino':'radio','No definido':'radio'};
    const formButtons = {'Enviar':'btnSend','X':'closeForm'};
...
class Formulario{
    ...
    private setCloseButton(button:any){   
